...
@Component({
  ...
  styles: [`
    ...
    .sidenav { width: 256px; background: var(--bg-card, #fff); border-right: 1px solid #edf1f7; }
    .logo-container { padding: 16px 24px; border-bottom: 1px solid #edf1f7; }
    .logo { margin: 0; font-size: 1.25rem; font-weight: 700; color: #3366ff; }
    .toolbar { position: sticky; top: 0; z-index: 10; }
    .content { padding: 24px; min-height: calc(100vh - 128px); }
